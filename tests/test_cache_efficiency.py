...
from src.prompts.manager import CHUNK_SIZE, TURN_BOUNDARY, DeterministicPromptBuilder
...
class TestPrefixAlignment:
    ...
    def test_prefix_hash_identical_across_agents(self, sample_manual: str):
        ...
        prompts = {agent: builder.build(agent, [], "What is the ATM limit?") for agent in agents}
...
class TestChunkAlignment:
    ...
    def test_turn_boundary_in_history(self, sample_manual: str):
        ...
        assert TURN_BOUNDARY in formatted, "Turn boundary marker not found in formatted history"
